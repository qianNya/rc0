...
class SceneMasonryGrid extends StatelessWidget {
  const SceneMasonryGrid({
    super.key,
    required this.items,
    required this.onTap,
    this.onLongPress,
  ...
  final void Function(SceneEntry entry) onTap;
  final void Function(SceneEntry entry)? onLongPress;
  final int Function(SceneEntry entry)? screenplayCountFor;
  final int? Function(SceneEntry entry)? favoriteCountFor;
  final String? Function(SceneEntry entry)? localCoverFor;
