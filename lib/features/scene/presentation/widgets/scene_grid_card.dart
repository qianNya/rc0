...
class SceneGridCard extends StatelessWidget {
  const SceneGridCard({
    super.key,
    required this.entry,
    required this.onTap,
  ...
  Widget build(BuildContext context) {
    ...
    final favorites = favoriteCount ?? entry.favoriteCount;
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '$scripts个剧本 · ${formatSceneCount(entry.useCount)}使用',
