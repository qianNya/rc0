...
> 本文档为速查表。完整设计规范见 `docs/design/`：[UI_STYLE_GUIDE.md](design/UI_STYLE_GUIDE.md)（视觉/材质）· [UX_GUIDELINES.md](design/UX_GUIDELINES.md)（体验/交互）· [PRODUCT_CONCEPT.md](design/PRODUCT_CONCEPT.md)（产品创意）。
