...
> Legacy-reference：本文件含 Go 时代/旧客户端生成说明。全栈重构 API 契约以后端 `C:/Users/qianlNya/RustroverProjects/rc0-rust/docs/openapi.yaml` 与 `docs/refactor/TECHNICAL_DESIGN.md` 为准；文档状态见 `docs/README.md`。
