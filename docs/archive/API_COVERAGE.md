...
> Legacy-reference：本文件仅记录历史 API 覆盖情况。API 契约以后端 `C:/Users/qianlNya/RustroverProjects/rc0-rust/docs/openapi.yaml` 与真实 handler/service 代码为准；文档状态见 `docs/README.md`。
